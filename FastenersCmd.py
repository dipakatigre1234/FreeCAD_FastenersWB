...
FSScrewCommandTable = {
    ...
    "ASMEB18.5.1":(translate("FastenerCmd", "UNC Round head bolts"), OtherHeadGroup, ScrewParametersLC),
    "ASMEB18.5.3":(translate("FastenerCmd", "UNC Round head short square neck bolts"), OtherHeadGroup, ScrewParametersLC),
    "ASMEB18.5.4":(translate("FastenerCmd", "UNC Round head ribbed neck bolts"), OtherHeadGroup, ScrewParametersLC),
    "ASMEB18.5.5":(translate("FastenerCmd", "UNC Round head fin neck bolts"), OtherHeadGroup, ScrewParametersLC),
    "ASMEB18.5.6":(translate("FastenerCmd", "UNC Step bolts"), OtherHeadGroup, ScrewParametersLC),
    "ASMEB18.5.7":(translate("FastenerCmd", "UNC Countersunk bolts"), OtherHeadGroup, ScrewParametersLC),
    "ASMEB18.5.8":(translate("FastenerCmd", "UNC 114-deg countersunk square neck bolts"), OtherHeadGroup, ScrewParametersLC),
    "ASMEB18.5.9":(translate("FastenerCmd", "UNC Flat countersunk head elevator bolts"), OtherHeadGroup, ScrewParametersLC),
    "ASMEB18.5.10":(translate("FastenerCmd", "UNC T-head bolts"), OtherHeadGroup, ScrewParametersLC),
    ...
    "DIN605":(translate("FastenerCmd", "Flat countersunk head square neck bolt with long neck"), OtherHeadGroup, ScrewParametersLC),
    "DIN608":(translate("FastenerCmd", "Flat countersunk head square neck bolt"), OtherHeadGroup, ScrewParametersLC),
    "DIN186":(translate("FastenerCmd", "T-head bolt"), OtherHeadGroup, ScrewParametersLC),
    "DIN188":(translate("FastenerCmd", "T-head bolt (double nib)"), OtherHeadGroup, ScrewParametersLC),
    ...
    "ASMEB18.6.9.2": (translate("FastenerCmd", "Wing nuts, type 2"), NutGroup, NutParameters),
    "ASMEB18.6.9.3": (translate("FastenerCmd", "Wing nuts, type 3"), NutGroup, NutParameters),
    "ASMEB18.6.9.4A": (translate("FastenerCmd", "Wing nuts, type 4A"), NutGroup, NutParameters),
    "ASMEB18.6.9.4B": (translate("FastenerCmd", "Wing nuts, type 4B"), NutGroup, NutParameters),
    "ASMEB18.6.9.6": (translate("FastenerCmd", "Wing nuts, type 6"), NutGroup, NutParameters),
    ...
    "DIN436": (translate("FastenerCmd", "Square washer"), WasherGroup, WasherParameters),
