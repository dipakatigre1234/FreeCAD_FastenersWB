...
DEVIATION_PCT_SMALL  = 0.0    # % subtracted at the smallest dia in metric_thread_dia.csv
DEVIATION_PCT_LARGE  = 0.0    # % subtracted at the largest  dia in metric_thread_dia.csv
